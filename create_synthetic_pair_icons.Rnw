...
\tikz{\path (0,0) node[inner sep=0,outer sep=0]{
  ...
  {\bf 14 day RSI}, last relative price location inside {\bf 6 month range} $100*\frac{LAST-LOW}{HIGH-LOW}$  \\
  12m, 6m, 1m relative price plot, computed off current exposures. \Sexpr{dot("red")} low, \Sexpr{dot("green")} high \\

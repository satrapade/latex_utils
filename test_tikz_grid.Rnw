...
tikz_plot_matrix(
  content=apply(
    pair_matrix,
    1:2,
    function(e)ifelse(match(pair2manager(e),managers,nomatch=0)>0,icon(e,width="18mm",height="18mm"),"")
  ),
  node=apply(
    pair_matrix,
    1:2,
    function(e)ifelse(match(pair2manager(e),managers[1],nomatch=0)>0,
